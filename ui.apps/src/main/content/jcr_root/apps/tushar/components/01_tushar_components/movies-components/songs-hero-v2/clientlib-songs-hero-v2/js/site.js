...
var songss = document.getElementById('flat-black-player-container');
var sonngsjson=songss.getAttribute('songsJson')

console.log("songsJson"+JSON.parse(sonngsjson));
Amplitude.init({

  "songs":JSON.parse(sonngsjson)  
  /*"songs": [
    {
