...
public class MyPracticeSecondWorkflowProcess implements WorkflowProcess{

    protected final Logger logger = LoggerFactory.getLogger(MyPracticeSecondWorkflowProcess.class);
