...
public class MyOSGIEventHandler implements EventHandler {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MyOSGIEventHandler.class);

    @Reference
    ResourceResolverFactory resourceResolverFactory;

    public void handleEvent(final Event event) {
        LOG.info("\n OSGI event Detected: {} at: {}", event.getTopic(), event.getProperty(SlingConstants.PROPERTY_PATH));
        try {
